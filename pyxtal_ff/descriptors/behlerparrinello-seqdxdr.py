            ...
            if self.G2_parameters is not None:
                ...
                if self.derivative:
                    ...
                    if GiPrime is None:
                        ...
                        GiPrime = np.append(GiPrime, G2iP, axis=0)
                        if self.stress:
                            rGiPrime = np.append(rGiPrime, rG2iP, axis=0)
            ...
            if self.G4_parameters is not None:
                ...
                if self.derivative:
                    ...
                    if GiPrime is None:
                        ...
                        GiPrime_seq = np.append(GiPrime_seq, seq, axis=0)
                        GiPrime = np.append(GiPrime, G4iP, axis=0)
                        if self.stress:
                            rGiPrime = np.append(rGiPrime, rG4iP, axis=0)
            ...
            if self.G5_parameters is not None:
                ...
                if self.derivative:
                    ...
                    if GiPrime is None:
                        ...
                        GiPrime_seq = np.append(GiPrime_seq, seq, axis=0)
                        GiPrime = np.append(GiPrime, G5iP, axis=0)
                        if self.stress:
                            rGiPrime = np.append(rGiPrime, rG5iP, axis=0)
            
            self.all_G['x'].append(Gi)
            self.all_G['elements'].append(element)
            if self.derivative:
                self.all_G['seq'].append(GiPrime_seq)
